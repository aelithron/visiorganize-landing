...
export default function Home() {
  return (
    <main className="flex flex-col items-center min-h-screen">
      <div className="flex flex-col bg-gradient-to-br from-blue-300 to-purple-300 dark:from-blue-500 dark:to-purple-600 min-w-screen text-center p-8 md:px-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 grid-rows-2 md:grid-rows-1 bg-purple-300 dark:bg-violet-600 min-w-screen text-center p-8 md:px-20 place-content-center gap-4">
        <div>
